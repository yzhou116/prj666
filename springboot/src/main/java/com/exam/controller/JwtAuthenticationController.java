...
public class JwtAuthenticationController {
  ...
  public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest)
    ...
    if (authenticationRequest.getType().equals("Admin")) {
      ...
      boolean checker =
          bCryptPasswordEncoder.matches(authenticationRequest.getPassword(), admin.getPwd());
      if (checker) {
      ...
      boolean checker =
          bCryptPasswordEncoder.matches(authenticationRequest.getPassword(), teacher.getPwd());
      if (checker) {
        final UserDetails userDetails =
            userDetailsService.loadUserByUsername(authenticationRequest.getUsername());
      ...
      boolean checker =
          bCryptPasswordEncoder.matches(authenticationRequest.getPassword(), student.getPwd());
      if (checker) {
        final UserDetails userDetails =
            userDetailsService.loadUserByUsername(authenticationRequest.getUsername());
