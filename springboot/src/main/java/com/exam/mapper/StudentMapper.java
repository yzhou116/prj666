...
public interface StudentMapper {
   ...
   */
  @Update(
      "update student set studentName = #{studentName},grade = #{grade},major = #{major},clazz ="
          + " #{clazz},institute = #{institute},tel = #{tel},email = #{email},pwd = #{pwd},cardId ="
          + " #{cardId},sex = #{sex},role = #{role} where studentId = #{studentId}")
