...
) ENGINE=InnoDB AUTO_INCREMENT=20190030 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='考试管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10044 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='填空题题库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `judge_question` (
  ...
  `teacher` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10030 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='判断题题库表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `multi_question` (
  ...
  `teacher` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10059 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='选择题题库表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='成绩管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `surveyRs` VALUES ('f1f390fe-982c-4c13-b3b2-0c69813093a7',20190021,'yyyzhou111@gmail.com','{\r\n  \"10035\" : \"qwe\",\r\n  \"10019\" : \"Wrong\",\r\n  \"10036\" : \"asd\",\r\n  \"10040\" : \"A\",\r\n  \"10041\" : \"D\"\r\n}','2023-01-28'),('0efae9d0-ae61-4d1f-b1cd-3501f2de00db',20190021,'yizhou000@gmail.com','{\r\n  \"10035\" : \"ccc\",\r\n  \"10019\" : \"Correct\",\r\n  \"10036\" : \"zzz\",\r\n  \"10040\" : \"C\",\r\n  \"10041\" : \"A\"\r\n}','2023-01-28'),('6fe8f9df-06cb-44dd-a99d-e11ebbbdcace',20190021,'yyyzhou999@gmail.com','{\r\n  \"10035\" : \"qqq\",\r\n  \"10019\" : \"Correct\",\r\n  \"10036\" : \"www\",\r\n  \"10040\" : \"D\",\r\n  \"10041\" : \"C\"\r\n}','2023-01-28'),('ea44dce5-027b-4688-aa6d-b57fa195459e',20190021,'yyyzhou555@gmail.com','{\r\n  \"10035\" : \"gdgf\",\r\n  \"10019\" : \"Correct\",\r\n  \"10036\" : \"dfgd\",\r\n  \"10040\" : \"B\",\r\n  \"10041\" : \"D\"\r\n}','2023-01-29'),('3e5d766a-e1d7-4399-85a2-97283f382b74',20190027,'yzhou116@gmail.com','{\r\n  \"10051\" : \"A\",\r\n  \"10052\" : \"B\",\r\n  \"10041\" : \"sdf\",\r\n  \"10027\" : \"Wrong\"\r\n}','2023-02-15'),('1b6ec7d8-8a3d-4706-8290-c942d2eab77c',20190021,'yzhou120@gmail.com','{\r\n  \"10035\" : \"AAAAAA\",\r\n  \"10019\" : \"Wrong\",\r\n  \"10036\" : \"ccc\",\r\n  \"10040\" : \"B\",\r\n  \"10041\" : \"A\"\r\n}','2023-02-20'),('bb4ec262-b941-4094-9fdf-6f71b89f824f',20190021,'yzhou111@gmail.com','{\r\n  \"10035\" : \"ZZZZZ\",\r\n  \"10019\" : \"Correct\",\r\n  \"10036\" : \"VVVVV\",\r\n  \"10040\" : \"D\",\r\n  \"10041\" : \"D\"\r\n}','2023-02-20'),('a05673fc-897d-445d-938e-f706eadb88d9',20190029,'yzhou116@gmail.com','{\r\n  \"10055\" : \"A\",\r\n  \"10056\" : \"B\",\r\n  \"10057\" : \"C\",\r\n  \"10058\" : \"A\",\r\n  \"10029\" : \"Wrong\"\r\n}','2023-02-25'),('1310a5a9-df1c-43ef-ba70-7c21ab8cb3d2',20190029,'goodtimmy','{\r\n  \"10055\" : \"B\",\r\n  \"10056\" : \"C\",\r\n  \"10057\" : \"D\",\r\n  \"10058\" : \"A\",\r\n  \"10029\" : \"Wrong\"\r\n}','2023-02-25'),('53337714-6924-4d1b-b7c0-9375a2b03f53',20190029,'badthomas','{\r\n  \"10055\" : \"D\",\r\n  \"10056\" : \"A\",\r\n  \"10057\" : \"B\",\r\n  \"10058\" : \"C\",\r\n  \"10029\" : \"Correct\"\r\n}','2023-02-25'),('de74faa6-bc72-4c3c-aaee-bafc3a4fdddf',20190029,'badthomas','{\r\n  \"10055\" : \"D\",\r\n  \"10056\" : \"D\",\r\n  \"10057\" : \"D\",\r\n  \"10058\" : \"D\",\r\n  \"10029\" : \"Correct\"\r\n}','2023-02-25');
...
INSERT INTO `teacher` VALUES (20081001,'yzhou116@gmail.com','Walter Bald','School of Software ','M','13598458442','13598458442@163.com','$2a$10$ozHTsgz3TOQke1kJeVl6S.zqPxZIU478I9Ul9Vbthl/rm8Pvg.Klm','423423283498','Teacher','1'),(20081002,'yzhou117@gmail.com','Beluga Cat','School of Software ','M','1231221312','1231221312@163.com','$2a$10$QkUelr8RRLGdqPaQ0vOKN.Shj/qhloTsALBdIqOdhlXTrzI4byUAq','24241234','Teacher','1'),(20081003,NULL,'Tom','Seneca','Mal','6478878878',NULL,'Sd!4888202','None','Teacher','2');
...
-- Dump completed on 2023-02-25 21:37:11
