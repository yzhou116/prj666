                     ...
                     <ul>
                        <li v-for="(list, index1) in topic[1]" :key="index1">
                           ...
                           >
                              <span
                                 :class="{
                                    mark: topic[1][index1].isMark == true,
                                 }"
                              ></span>
                              {{ index1 + 1 }}
                           </a>
                     ...
                     <ul>
                        <li v-for="(list, index2) in topic[2]" :key="index2">
                           <a
                              ...
                              ><span
                                 :class="{
                                    mark: topic[2][index2].isMark == true,
                                 }"
                              ></span
                     ...
                     <ul>
                        <li v-for="(list, index3) in topic[3]" :key="index3">
                           <a
                              ...
                              ><span
                                 :class="{
                                    mark: topic[3][index3].isMark == true,
                                 }"
                              ></span
                              >{{
            ...
            <div class="right">
               <div class="title">
                  ...
                  <span
                     ...
                     <i class="iconfont icon-time"></i>Count Down:
                     <b>{{ time }}</b
                     >Mins</span
                  >
               </div>
               <div class="content">
                  ...
                  <div v-if="currentType == 1">
                     ...
                     <div class="analysis" v-if="isPractice">
                        <ul>
                           <li>
                              <el-tag type="success">Right Answer</el-tag
                              ><span class="right">{{
               ...
               <div class="operation">
                  <ul class="end">
                     ...
                     <li @click="mark()">
                        <i class="iconfont icon-mark-o"></i><span>Mark</span>
                     </li>
                     <li @click="next()">
                        <span>Next</span><i class="iconfont icon-next"></i>
                     </li>
                  </ul>
               </div>
            </div>
...
export default {
   ...
   methods: {
      ...
      commit() {
         ...
         if (this.time != 0) {
            this.$confirm(
               "The time is not reach to the end",
               "Friendly Reminder",
               {
