...
<!--     <footer id="footer">
    <ul>
      ...
      <li><a href="javascript:;">Some Text</a></li>
      <li><a href="javascript:;">User Aggreement</a></li>
      <li><a href="http://beian.miit.gov.cn/" target="_blank">Some text here</a></li>
      <li>@Copyright xxxx-xxxx. ALL Rights Reserved</li>
    </ul>
  </footer> -->
  </template>
    ...
    methods: {
      ...
      commit() { 
        ...
        if(this.issurvey){
            ...
            let tokenStr = this.$session.get('jwt')
            console.log("this is the this.topic1Answer ->" + JSON.stringify(this.topic1Answer))
            console.log("this is the this.fillAnswer ->" + JSON.stringify(this.fillAnswer))
            console.log("this is the this.judgeAnswer ->" + JSON.stringify(this.judgeAnswer))
            console.log("this is the this.studentEmail ->" + this.userEmail)
            console.log("this is the this.examCode ->" + this.examData.examCode)
        const headers = 
        {
         ...
         'Authorization' : 'Bearer ' + tokenStr
           ...
           /*    url: '/api/score', */
              ...
              data: {
               ...
               // thetopic :  this.topic
               multiQuestionList : this.topic["1"],
               fillQuestionList : this.topic["2"],
            ...
            console.log("this is the topic answers ->" + JSON.stringify(this.topic))

            console.log("this is the topic answers1 ->" + JSON.stringify(this.topic["1"]));
