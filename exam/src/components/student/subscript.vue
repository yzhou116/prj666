    ...
    <div id="myExam">
      ...
      <div class="wrapper">
        <ul class="top">
          ...
          <li><el-button type="primary" @click="search()">Seach Exam</el-button></li>
        </ul>
        <ul class="paper" >
          <li class="item" >
            ...
            <div class="info">
              ...
              <i class="iconfont icon-icon-time"></i><span>Limit 120 mins</span>
              <i class="iconfont icon-fenshu"></i><span>Total 100 socres</span>
            </div>
          </li>
        </ul>
