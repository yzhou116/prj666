      ...
      <div class="wrapper">
         ...
         <ul class="info">
            <li @click="dialogVisible = true">
               <a href="javascript:;"
                  ><i class="iconfont icon-info"></i>Student Needs to Know</a
               >
            </li>
         </ul>
      </div>
            ...
            <el-collapse-item class="header" name="0">
               <template slot="title" class="stitle">
                  <div class="title">
                     ...
                     <span class="time"
                        >{{ examData.totalScore }}Mins /
                        {{ examData.totalTime }}Mins</span
                     >
                     <el-button type="primary" size="small"
                        >Please see the details</el-button
                     >
                  </div>
               </template>
               <el-collapse class="inner">
                  <el-collapse-item>
                     <template slot="title" name="1">
                        <div class="titlei">
                           MultiQuestion (Total{{ topicCount[0] }}Questions
                           Total{{ score[0] }}Score)
                        </div>
                     </template>
                     <div class="contenti">
                  ...
                  <el-collapse-item>
                     <template slot="title" name="2">
                        <div class="titlei">
                           Fill Blank (Total{{ topicCount[1] }}Questions Total{{
                              score[1]
                           }}Score)
                        </div>
                     </template>
                  ...
                  <el-collapse-item>
                     <template slot="title" name="3">
                        <div class="titlei">
                           True Or False (Total{{ topicCount[2] }}Questions
                           Total{{ score[2] }}Score)
                        </div>
                     </template>
                     <div class="contenti">
