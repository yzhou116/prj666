   ...
   <div class="add">
      <el-tabs v-model="activeName">
         <el-tab-pane name="first">
            <span slot="label"
               ><i class="el-icon-circle-plus"></i>Add Question Repo</span
            >
   ...
   methods: {
      ...
      create() {
         ...
         this.$axios({
            ...
            data: {
               ...
               subject: "Computer Network", //题目数量太少，指定为计算机网络出题
            },
            headers,
         }).then((res) => {
            console.log(res);
      ...
      changeSubmit() {
         ...
         this.$axios({
            ...
            .then(() => {
               ///api/multiQuestionId
               this.$axios(`http://localhost:8080/multiQuestionId`, {
                  headers,
               }).then((res) => {
                  //获取当前题目的questionId
      ...
      fillSubmit() {
         ...
         this.$axios({
            ...
            .then(() => {
               ///api/fillQuestionId
               this.$axios(`http://localhost:8080/fillQuestionId`).then(
                  (res) => {
                     //获取当前题目的questionId
                     let questionId = res.data.data.questionId;
                     this.postPaper.questionId = questionId;
      ...
      judgeSubmit() {
         ...
         this.$axios({
            ...
            .then(() => {
               ///api/judgeQuestionId
               this.$axios(`http://localhost:8080/judgeQuestionId`, {
                  headers,
               }).then((res) => {
                  //获取当前题目的questionId
                  let questionId = res.data.data.questionId;
