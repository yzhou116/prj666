<template>
    <div class="part" >
        <select v-model="selected.text" @change="onChange($event)">
  <option disabled value="">Please select one</option>
 <option v-for="(value, key) in myObject" v-bind:value="{ thevalue: value, text: key }">
         {{ key }}
       </option>
</select>
    ...
    <div v-if="!isPie">
      ...
      <span  style="white-space: pre-wrap;" v-for="item in this.fillAnswers"> {{item}} <br/> </span> 
    </div>
    </div>
  </template>
  <script>
