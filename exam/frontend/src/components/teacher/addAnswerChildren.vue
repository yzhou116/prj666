  ...
  methods: {
    ...
    changeSubmit() { //选择题题库提交
      ...
      url: `http://localhost:8080/MultiQuestion`,
        ...
        ///api/multiQuestionId
        this.$axios(`http://localhost:8080/multiQuestionId`,{headers}).then(res => { //获取当前题目的questionId
    ...
    judgeSubmit() { //判断题提交
      ...
      url: `http://localhost:8080/judgeQuestion`,
        ...
        ///api/judgeQuestionId
        this.$axios(`http://localhost:8080/judgeQuestionId`,{headers}).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
