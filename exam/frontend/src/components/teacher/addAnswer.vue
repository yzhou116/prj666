...
<template>
  <div class="exam">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="description" label="Introduction" width="200"></el-table-column>
      ...
      <el-table-column prop="examDate" label="Date" width="120"></el-table-column>
      ...
      <el-table-column fixed="right" label="Edit" width="150">
        <template slot-scope="scope">
          <el-button @click="add(scope.row.paperId,scope.row.source)" type="primary" size="small">Add Question</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
